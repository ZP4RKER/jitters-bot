...
public class Jitters {
    ...
    private static void generateConfig() throws Exception {
        ...
        // Legends
        array.put("Seriously, you idiots haven't figured this out by now? It all started when we blew up the time pigs, the " +
        ...
        // Constantine
        array.put("My name is %user%. I am the one who steps on the shadows, all trench coat and arrogance. I'll drive your demons " +
        ...
        JSONUtil.writeFile(root.toString(2), configFile);
    }
